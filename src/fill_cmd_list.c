...
/*   Updated: 2024/06/10 18:08:12 by nnourine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minishell.h"

static void	fill_cmd_list_helper(t_cmd *cmd, char **raw_cmd)
{
...
t_cmd	*fill_cmd_list(char **raw_cmd, t_env *env, t_env *original_env)
{
	...
	if (!cmd)
		master_clean(raw_cmd, 0, EXIT_FAILURE);
	...
	fill_cmd_list_helper(cmd, raw_cmd);
